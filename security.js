...
.directive( "questionsSecurity", function() {
	return {
		...
		template: "<a name='{{name}}'/>" +
				  ...
				  "	<span ng-show='answers'><span class='answer'>{{question.answer}}</span> <button class='w3-btn w3-khaki w3-round w3-small' ng-click='better(question.id);'>Suggest A Better Answer</button><br/></span>Correct <input class='{{name}}-correct' type='checkbox'/><br/><br/>" +
				  "</ul>" +
